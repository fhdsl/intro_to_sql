...
Our database lives in the `data/` folder as a single file called `synthea-smaller_breast_cancer.db`. I have pre-loaded the data so we can immediately start working with it. 
...
What column is the same in both tables? 
