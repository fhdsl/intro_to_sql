...
| Week | Date   | Subject                                                    |
| ---- | ------ | ---------------------------------------------------------- |
| 1    | Feb 7  | [Intro to SQL; `SHOW TABLES`, `DESCRIBE`, `SELECT`, `WHERE`](week1.html) |
...
- The material for this course can be viewed without login requirement on this [website](https://hutchdatascience.org/intro_to_sql/). This format might be most appropriate for you if you rely on screen-reader technology.
