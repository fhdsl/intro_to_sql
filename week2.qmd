...
Joining tables require understanding the relationship between tables in a database, and it is helpful to visualize it via an **entity-relationship diagram:**
...
The full OMOP entity-relationship diagram can be [found here](https://ohdsi.github.io/CommonDataModel/cdm54erd.html).
